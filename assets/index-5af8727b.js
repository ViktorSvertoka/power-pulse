...
`,fQ=O.li`
  margin-top: 32px;
`,ff=({itemsPerPage:e,totalItems:t,currentPage:n,onPageChange:r})=>{const i=Math.ceil(t/e),o=s=>{s>=1&&s<=i&&r(s)},a=()=>{const s=[];for(let l=1;l<=i;l++)s.push(p.jsx(fQ,{className:`page-item ${l===n?"active":""}`,children:p.jsxs("button",{className:"page-link",onClick:()=>o(l),children:[l,l===n&&p.jsx("svg",{children:p.jsx("use",{href:`${ce}#pagination-btn`})})]})},l));return s};return p.jsx("nav",{"aria-label":"Pagination",children:p.jsx("ul",{className:"pagination",children:a()})})};ff.propTypes={itemsPerPage:ie.number.isRequired,totalItems:ie.number.isRequired,currentPage:ie.number.isRequired,onPageChange:ie.func.isRequired};const PP=({handleFilterClick:e,handleSetExName:t})=>{const n=St();S.useEffect(()=>{n(Tc())},[n]);const r=Pt(oQ),[i,o]=S.useState(1),a=()=>{const h=window.innerWidth;return h>=768&&h<=1439?9:10},[s,l]=S.useState(a),u=()=>{l(a())};S.useEffect(()=>(window.addEventListener("resize",u),u(),()=>{window.removeEventListener("resize",u)}),[]);const c=h=>{o(h)},d=i*s,f=d-s,m=r.slice(f,d);return p.jsxs(F0,{children:[p.jsx(I0,{children:m.map(h=>p.jsx(pf,{exercisesItem:h,handleFilterClick:e,handleSetExName:t},h._id))}),s<r.length&&p.jsx(ff,{itemsPerPage:s,totalItems:r.length,currentPage:i,onPageChange:c})]})};PP.propTypes={bodyParts:ie.array};const hQ=O.div`
  padding-left: 20px;
  padding-right: 20px;
...
`,kK=()=>{const e=St(),t=Pt(Gi),n=[{id:"1",value:"1",label:"1"},{id:"2",value:"2",label:"2"},{id:"3",value:"3",label:"3"},{id:"4",value:"4",label:"4"}],r=[{id:"Male",value:"male",label:"Male"},{id:"Female",value:"female",label:"Female"}],i=[{id:"level-1",value:"1",label:"Sedentary lifestyle (little or no physical activity)"},{id:"level-2",value:"2",label:"Light activity (light exercises/sports 1-3 days per week)"},{id:"level-3",value:"3",label:"Moderately active (moderate exercises/sports 3-5 days per week)"},{id:"level-4",value:"4",label:"Very active (intense exercises/sports 6-7 days per week)"},{id:"level-5",value:"5",label:"Extremely active (very strenuous exercises/sports and physical work)"}],o=new Date(t.birthday).toISOString().split("T")[0],a={name:t.name||"Name",height:t.height||"150",currentWeight:t.currentWeight||"35",desiredWeight:t.desiredWeight||"35",birthday:o||"2005-01-01",blood:(t.blood??"1").toString()||"1",sex:t.sex||"male",levelActivity:(t.levelActivity??"1").toString()||"1"},s=Zp({name:ka().required("Name is required"),height:Br().positive("Height must be positive").required("Height is required"),currentWeight:Br().positive("Weight must be positive").required("Current weight is required"),desiredWeight:Br().positive("Weight must be positive").required("Desired weight is required"),birthday:Jp().required("Birthday is required")}),l=u=>{const c={...u};e(Gs(c)),console.log(c)};return p.jsx(Zy,{initialValues:a,validationSchema:s,onSubmit:l,children:u=>p.jsxs(e0,{children:[p.jsxs(wK,{children:[p.jsxs("div",{children:[p.jsx(Uu,{children:"Basic info"}),p.jsx(uo,{name:"name",type:"text",as:I2})]}),p.jsx("div",{children:p.jsx(I2,{type:"text",name:"email",defaultValue:t.email,readOnly:!0})})]}),p.jsxs(F2,{children:[p.jsxs("div",{children:[p.jsx(Uu,{children:"Height"}),p.jsx(uo,{type:"number",name:"height",as:Vu})]}),p.jsxs(bK,{children:[p.jsx(Uu,{children:"Current Weight"}),p.jsx(uo,{type:"number",name:"currentWeight",as:Vu})]})]}),p.jsxs(F2,{children:[p.jsxs("div",{children:[p.jsx(Uu,{children:"Desired Weight"}),p.jsx(uo,{type:"number",name:"desiredWeight",as:Vu})]}),p.jsx(uo,{type:"date",name:"birthday",as:Vu})]}),p.jsxs(SK,{children:[p.jsxs("div",{style:{display:"flex",marginRight:"20px"},children:[p.jsx("div",{style:{display:"flex",marginRight:"20px"},children:n.map(c=>p.jsx(So,{id:c.id,name:"blood",value:c.value,checked:u.values.blood===c.value,label:c.label,onChange:()=>u.setFieldValue("blood",c.value)},c.id))}),p.jsx("div",{style:{display:"flex"},children:r.map(c=>p.jsx(So,{id:c.id,name:"sex",value:c.value,checked:u.values.sex===c.value,label:c.label,onChange:()=>u.setFieldValue("sex",c.value)},c.id))})]}),p.jsx(CK,{children:i.map(c=>p.jsx(So,{id:c.id,name:"levelActivity",value:c.value,checked:u.values.levelActivity===c.value,label:c.label,onChange:()=>u.setFieldValue("levelActivity",c.value)},c.id))})]}),p.jsx(EK,{type:"submit",children:"Save"})]})})},OK=O(Pr)`
  display: flex;
  justify-content: flex-end;
  align-items: center;
  color: var(--white-color);
