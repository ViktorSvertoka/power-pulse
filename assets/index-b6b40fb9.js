...
`,HH={Table:`
  ...
  `).concat(function(){},`
  background-color: inherit;
`),GH=rn(__,";",""),A2=S.forwardRef(function(e,t){var n=S.useContext(Ar);if(!n)throw new Error("No Layout Context.");var r=n.layout,i=r!=null&&r.isDiv?"div":"td";return ie(i,hr({css:GH,ref:t},e))}),XH=rn(__," z-index:1;text-align:left;position:sticky;top:0;&.pin-left,&.pin-right{z-index:3;}",""),I2=S.forwardRef(function(e,t){var n=S.useContext(Ar);if(!n)throw new Error("No Layout Context.");var r=n.layout,i=r!=null&&r.isDiv?"div":"th";return ie(i,hr({css:XH,ref:t},e))}),ZH={name:"1k13m5t",styles:"z-index:2;position:absolute;top:0;right:0;bottom:0;width:1px;margin:4px 0"},F2=function(e){var t=typeof e=="boolean"||(e==null?void 0:e.resizerWidth)==null?10:e.resizerWidth,n=typeof e=="boolean"||(e==null?void 0:e.resizerHighlight)==null?"transparent":e.resizerHighlight;return{handle:ZH,area:rn("z-index:1;position:absolute;top:0;right:0;bottom:0;cursor:ew-resize;width:",t,"px;height:100%;&:hover,&.active{background-color:",n,";}","")}},D_=function(e,t){(t==null||t>e.length)&&(t=e.length);for(var n=0,r=new Array(t);n<t;n++)r[n]=e[n];return r},N2=D_,j_=function(e,t){if(e){if(typeof e=="string")return N2(e,t);var n=Object.prototype.toString.call(e).slice(8,-1);return n==="Object"&&e.constructor&&(n=e.constructor.name),n==="Map"||n==="Set"?Array.from(e):n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?N2(e,t):void 0}},JH=function(e){if(Array.isArray(e))return e},eY=function(e,t){if(typeof Symbol<"u"&&Symbol.iterator in Object(e)){var n=[],r=!0,i=!1,o=void 0;try{for(var a,s=e[Symbol.iterator]();!(r=(a=s.next()).done)&&(n.push(a.value),!t||n.length!==t);r=!0);}catch(l){i=!0,o=l}finally{try{r||s.return==null||s.return()}finally{if(i)throw o}}return n}},tY=j_,nY=function(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
...
`," ",t?i==null?void 0:i.Footer:i==null?void 0:i.Header,";","")},r),S.Children.map(n,function(l){if(S.isValidElement(l))return S.cloneElement(l)}))},Q2=null,OY=function(){return Q2||(Q2=S.createContext(null))},TY=["data","theme","layout","sort","pagination","select","tree","onInit","className","children"],PY={Table:`
    height: 100%;
  `},K2=S.forwardRef(function(e,t){var n=e.data,r=e.theme,i=e.layout,o=e.sort,a=e.pagination,s=e.select,l=e.tree,u=e.onInit,c=u===void 0?function(){}:u,d=e.className,p=d===void 0?"table":d,m=e.children,h=Go(e,TY),g=function(X){var Y=S.useRef(null);return X&&(Y=X),Y}(t),x=function(X){var Y=S.useRef(null);return Y.current||(Y.current={onlyOnce:!1,dataColumns:[]}),Y}(),v=bY({sort:o,pagination:a,tree:l,select:s})(n.nodes),y=function(X,Y){var I=S.useState(!1),Q=Rv(I,2),ee=Q[0],he=Q[1];return[ee,function(F){F&&(ee||(he(!0),Y.current=F,X(F)))}]}(c,g),b=Rv(y,2),w=b[0],E=b[1],C=xY(),k=[];i!=null&&i.fixedHeader&&(k=k.concat(PY)),r&&(k=k.concat(r));var _,D=EY(k),$=i!=null&&i.isDiv?"div":"table",z=OY(),L=lY(),N=gY(),G=pY(),K=yY();return ie($,hr({role:"grid","data-table-library_table":"",css:rn((_={isShiftDown:C},`
  *,
  *:before,
  *:after {
    box-sizing: border-box;
...
`],[`
  animation: `,` 0.75s steps(12, end) infinite;
  animation-duration: `,`s;
`])),kq,Cq("speed","0.75"));vu.polyline(DS||(DS=Ex([`
  stroke-width: `,`px;
...
`,qG=e=>{const t=String(e.getDate()).padStart(2,"0"),n=String(e.getMonth()+1).padStart(2,"0"),r=e.getFullYear();return`${t}/${n}/${r}`},DD=({eldata:e,onClick:t,closeModal:n})=>{const r=kt(),{title:i,calories:o,category:a,weight:s,_id:l}=e,[u,c]=S.useState(1),p=lt(li).blood;S.useEffect(()=>{r(So())},[r]);const m=Math.round(u*o/100),h=localStorage.getItem("selectedDate");let g=new Date;if(h){const y=new Date(h);isNaN(y.getTime())||(g=y)}const x=qG(g),v=()=>{if(!m){Le.error("Must be greater than 0");return}r(Lc({date:x,title:i,productId:l,category:a,weight:s,amount:u,recommended:e.groupBloodNotAllowed[p],calories:o})).then(()=>{t(m)}).catch(y=>{Le(y.message)})};return f.jsx(FG,{children:f.jsxs(NG,{children:[f.jsxs(LG,{children:[f.jsx("label",{children:f.jsx(zG,{type:"text",value:i,disabled:!0})}),f.jsxs("label",{style:{position:"relative"},children:[f.jsx(BG,{value:u,type:"number",min:1,onChange:y=>c(y.target.value)}),f.jsx(UG,{children:"weight"})]})]}),f.jsx("br",{}),f.jsx(yE,{children:f.jsxs(yE,{children:["Calories: ",f.jsx(WG,{children:m})]})}),f.jsx("br",{}),f.jsxs(VG,{children:[f.jsx(HG,{type:"button",onClick:v,children:"Add to diary"}),f.jsx(YG,{type:"button",onClick:n,children:"Cancel"})]})]})})};DD.propTypes={eldata:pe.object.isRequired,onClick:pe.func.isRequired,closeModal:pe.func.isRequired};const QG="/power-pulse/assets/avocado-2x-1cf208a8.png",KG=O.div`
    display: flex;
    flex-direction: column;
    align-items: center;
`,GG=O.div`
...
`,nX=O.svg`
    ...
    height: 16px;
    stroke: var(--white-color);
`,jD=({calories:e,closeModal:t})=>f.jsx(KG,{children:f.jsxs(GG,{children:[f.jsxs(XG,{children:[f.jsx(ZG,{src:QG,alt:"avocado"}),f.jsx(JG,{children:"Well done"}),f.jsxs(xE,{children:["Calories:"," ",f.jsx(eX,{children:e})]})]}),f.jsx(jr,{to:"/products",onClick:t,children:f.jsx(tX,{children:"Next product"})}),f.jsx(jr,{to:"/diary",onClick:t,children:f.jsxs(xE,{children:["To the diary",f.jsx(nX,{children:f.jsx("use",{href:be+"#icon-arrow-right",children:" "})})]})})]})});jD.propTypes={calories:pe.number.isRequired,closeModal:pe.func.isRequired};const rX=O.div`
 @media screen and (min-width: 375px) {
    display: inline-block;
    margin-top: 24px;
  }
...
`,EX=O.li`
  margin-top: 32px;
`,Yf=({itemsPerPage:e,totalItems:t,currentPage:n,onPageChange:r})=>{const i=Math.ceil(t/e),o=s=>{s>=1&&s<=i&&r(s)},a=()=>{const s=[];for(let l=1;l<=i;l++)s.push(f.jsx(EX,{className:`page-item ${l===n?"active":""}`,children:f.jsxs("button",{className:"page-link",onClick:()=>o(l),children:[l,l===n&&f.jsx("svg",{children:f.jsx("use",{href:`${be}#pagination-btn`})})]})},l));return s};return f.jsx("nav",{"aria-label":"Pagination",children:f.jsx("ul",{className:"pagination",children:a()})})};Yf.propTypes={itemsPerPage:pe.number.isRequired,totalItems:pe.number.isRequired,currentPage:pe.number.isRequired,onPageChange:pe.func.isRequired};const $D=({handleFilterClick:e,handleSetExName:t})=>{const n=kt();S.useEffect(()=>{n(Qc())},[n]);const r=lt(hX),[i,o]=S.useState(1),a=()=>{const h=window.innerWidth;return h>=768&&h<=1439?9:10},[s,l]=S.useState(a),u=()=>{l(a())};S.useEffect(()=>(window.addEventListener("resize",u),u(),()=>{window.removeEventListener("resize",u)}),[]);const c=h=>{o(h)},d=i*s,p=d-s,m=r.slice(p,d);return f.jsxs(jx,{children:[f.jsx(Dx,{children:m.map(h=>f.jsx(Hf,{exercisesItem:h,handleFilterClick:e,handleSetExName:t},h._id))}),s<r.length&&f.jsx(Yf,{itemsPerPage:s,totalItems:r.length,currentPage:i,onPageChange:c})]})};$D.propTypes={bodyParts:pe.array};const CX=O.div`
  padding-left: 20px;
  padding-right: 20px;
  margin-top: 10px;
...
`,wE=O.h2`
  ...
  line-height: 1.16;
  margin-bottom: 20px;
`,RD=({handleFilterClick:e,handleSetExName:t})=>{const n=kt();S.useEffect(()=>{n(Kc())},[n]);const r=lt(mX),[i,o]=S.useState(1),a=()=>{const h=window.innerWidth;return h>=768&&h<=1439?9:10},[s,l]=S.useState(a),u=()=>{l(a())};S.useEffect(()=>(window.addEventListener("resize",u),u(),()=>{window.removeEventListener("resize",u)}),[]);const c=h=>{o(h)},d=i*s,p=d-s,m=r.slice(p,d);return f.jsxs(jx,{children:[f.jsx(Dx,{children:m.map(h=>f.jsx(Hf,{exercisesItem:h,handleFilterClick:e,handleSetExName:t},h._id))}),s<r.length&&f.jsx(Yf,{itemsPerPage:s,totalItems:r.length,currentPage:i,onPageChange:c})]})};RD.propTypes={muscules:pe.array};const MD=({handleFilterClick:e,handleSetExName:t})=>{const n=kt();S.useEffect(()=>{n(Gc())},[n]);const r=lt(gX),[i,o]=S.useState(1),a=()=>{const h=window.innerWidth;return h>=768&&h<=1439?9:(h<375||h>=1440,10)},[s,l]=S.useState(a),u=()=>{l(a())};S.useEffect(()=>(window.addEventListener("resize",u),u(),()=>{window.removeEventListener("resize",u)}),[]);const c=h=>{o(h)},d=i*s,p=d-s,m=r.slice(p,d);return f.jsxs(jx,{children:[f.jsx(Dx,{children:m.map(h=>f.jsx(Hf,{exercisesItem:h,handleFilterClick:e,handleSetExName:t},h._id))}),s<r.length&&f.jsx(Yf,{itemsPerPage:s,totalItems:r.length,currentPage:i,onPageChange:c})]})};MD.propTypes={equipment:pe.array};const OX=O.ul`
  display: flex;
  gap: 28px;
  margin-bottom: 48px;
  @media screen and (min-width: 1440px) {
...
`,NX=O.span`
  color: var(--white-color);
`,nc={cardLabel:"Workout",btnLabel:"Start",list:{burnedCalories:"Burned calories:",bodyPart:"Body part:",target:"Target:"}},bE=e=>e.slice(0,1).toUpperCase()+e.slice(1),LX=({data:e,openModalToggle:t})=>f.jsxs(TX,{children:[f.jsxs(PX,{children:[f.jsx(_X,{children:nc.cardLabel}),f.jsxs(DX,{onClick:()=>{t(e)},type:"button",children:[nc.btnLabel,f.jsx("span",{children:f.jsx(jX,{children:f.jsx("use",{href:`${be}#icon-arrow-right`})})})]})]}),f.jsxs($X,{children:[f.jsx(AX,{children:f.jsxs(MX,{width:24,height:24,children:[f.jsx("use",{href:`${be}#icon-run-exercises`}),f.jsx("use",{href:`${be}#icon-running-stick-figure`})]})}),f.jsxs(RX,{children:[bE(e.name)," "]})]}),f.jsx(IX,{children:Object.keys(nc.list).map(n=>f.jsxs(FX,{children:[nc.list[n],f.jsx(NX,{children:bE(String(e[n]))})]},n))})]}),zX=O.div`
  display: flex;
`,BX=O.img`
  display: none;
  @media screen and (min-width: 1440px) {
...
`,EZ=O.svg`
  ...
  height: 16px;
  stroke: var(--white-color);
`,ND=({data:e,closeModal:t})=>(console.log(e),f.jsx(vZ,{children:f.jsxs(yZ,{children:[f.jsxs(xZ,{children:[f.jsx(wZ,{src:gZ,alt:"avocado"}),f.jsx(bZ,{children:"Well done"}),f.jsxs(Lm,{children:["Time",f.jsx(kE,{children:e})]}),f.jsxs(Lm,{children:["Burned calories",f.jsx(kE,{children:e})]})]}),f.jsx(jr,{to:"/exercises",onClick:t,children:f.jsx(SZ,{children:"Next exercise"})}),f.jsx(jr,{to:"/diary",onClick:t,children:f.jsxs(Lm,{children:["To the diary",f.jsx(EZ,{children:f.jsx("use",{href:be+"#icon-arrow-right",children:" "})})]})})]})}));ND.propTypes={burnedCalories:pe.number.isRequired,closeModal:pe.func.isRequired};const CZ=({exerciseName:e})=>{const[t,n]=S.useState(null),r=kt();S.useEffect(()=>{r(Qv())},[r]);const i=l=>{n(l)},o=()=>{n(null)},s=lt(fX).filter(l=>l.bodyPart||l.target||l.equipment===e);return f.jsxs(f.Fragment,{children:[t&&f.jsx(_x,{isOpenModalToggle:o,children:t.gifUrl?f.jsx(mZ,{data:t,closeModal:o,onClick:i}):f.jsx(ND,{closeModal:o,data:t,onClick:o})}),f.jsxs(zX,{children:[f.jsx(UX,{children:s.length?s.slice(0,50).map(l=>f.jsx(LX,{data:l,openModalToggle:i},l._id)):f.jsx(WX,{children:"There is not exercises downloaded else, plaese try choose this categorie later!!!"})}),f.jsx(BX,{src:VX,alt:"image"})]})]})},kZ=()=>{const[e,t]=S.useState("Body parts"),[n,r]=S.useState(""),i=s=>{r(s)},o=s=>{t(s)},a=s=>s.slice(0,1).toUpperCase()+s.slice(1);return f.jsxs(CX,{children:[f.jsxs(kX,{children:[e!=="Waist"?f.jsx(wE,{children:"Exercises"}):f.jsx(wE,{children:a(n)}),f.jsx(AD,{activeFilter:e,handleFilterClick:o})]}),e==="Body parts"&&f.jsx($D,{handleFilterClick:o,handleSetExName:i}),e==="Muscules"&&f.jsx(RD,{handleFilterClick:o,handleSetExName:i}),e==="Equipment"&&f.jsx(MD,{handleFilterClick:o,handleSetExName:i}),e==="Waist"&&f.jsx(CZ,{exerciseName:n})]})},OZ=()=>f.jsx(gs,{children:f.jsx(kZ,{})}),TZ=O.div`
  margin-left: 20px;
  margin-right: 20px;
...
`,AZ=O.p`
  ...
  font-weight: 400;
  line-height: 18px;
`,IZ=()=>f.jsx($Z,{children:f.jsxs(RZ,{children:[f.jsx(MZ,{children:f.jsx("svg",{width:"24",height:"24",children:f.jsx("use",{href:`${be}#icon-attention`})})}),f.jsx(AZ,{children:"We understand that each individual is unique, so the entire approach to diet is relative and tailored to your unique body and goals."})]})}),FZ=O.svg`
  position: absolute;
  top: 14px;
  right: 14px;
`,NZ=a0`
...
`,Kv=({color:e,iconId:t,text:n,value:r})=>f.jsxs(KZ,{color:e,children:[f.jsxs(GZ,{children:[f.jsx(XZ,{children:f.jsx("use",{href:`${be}#${t}`})}),f.jsx(ZZ,{children:n})]}),f.jsx(JZ,{children:r})]});Kv.propTypes={color:pe.string.isRequired,iconId:pe.string.isRequired,text:pe.string.isRequired,value:pe.string.isRequired};const eJ=()=>{const e=lt(li);return f.jsxs(TZ,{children:[f.jsx(_Z,{children:"Profile Settings"}),f.jsxs(PZ,{children:[f.jsxs("div",{children:[f.jsx(QZ,{}),f.jsxs(DZ,{children:[f.jsx(Kv,{color:"var(--orange-color)",iconId:"icon-fork-knife",text:"Daily calorie intake",value:e.bmr.toString()}),f.jsx(Kv,{color:"var(--orange-color)",iconId:"icon-dumbbell",text:"Daily norm of sports",value:"110 min"})]}),f.jsx(IZ,{}),f.jsx(qZ,{})]}),f.jsx(jZ,{children:f.jsx(VZ,{})})]})]})},tJ=O.section`
  max-width: 1400px;
  margin: 0 20px;
...
`,yJ=()=>f.jsx(gs,{children:f.jsxs(tJ,{children:[f.jsxs(rJ,{children:[f.jsx(_E,{children:f.jsx("use",{href:`${be}#icon-line`})}),f.jsx(PE,{children:"Transforming your body shape with Power Pulse"}),f.jsxs(iJ,{children:[f.jsx(jE,{to:"/signup",children:"Sign Up"}),f.jsx(DE,{to:"/signin",children:"Sign In"})]})]}),f.jsxs(nJ,{children:[f.jsx(PE,{children:"Transforming your body shape with Power Pulse"}),f.jsx(_E,{children:f.jsx("use",{href:`${be}#icon-line`})}),f.jsxs(oJ,{children:[f.jsx(jE,{to:"/signup",children:"Sign Up"}),f.jsx(DE,{to:"/signin",children:"Sign In"})]})]}),f.jsx(vJ,{children:f.jsxs(aJ,{children:[f.jsxs(sJ,{children:[f.jsx(uJ,{children:f.jsx(lJ,{children:f.jsx("use",{href:`${be}#icon-Polygon-1`})})}),f.jsxs(cJ,{children:["350+ ",f.jsx(dJ,{children:"Video tutorial"})]})]}),f.jsxs(pJ,{children:[f.jsx(hJ,{children:f.jsx(fJ,{children:f.jsx("use",{href:`${be}#icon-running-stick-figure`})})}),f.jsxs(mJ,{children:["500 ",f.jsx(gJ,{children:"cal"})]})]})]})})]})});function xJ(){const e=kt(),{goToParams:t,isRefreshing:n,isLoggedIn:r}=TT();return S.useEffect(()=>{e(Pc())},[e]),!n&&f.jsx(oj,{children:f.jsxs(Kn,{path:"/",element:f.jsx(JI,{}),children:[f.jsx(Kn,{index:!0,element:r?f.jsx(di,{to:"/diary",replace:!0}):f.jsx(yJ,{})}),f.jsx(Kn,{path:"signup",element:t?f.jsx(di,{to:"/params",replace:!0}):f.jsx(m7,{})}),f.jsx(Kn,{path:"params",element:t?f.jsx(LW,{}):f.jsx(di,{to:"/diary",replace:!0})}),f.jsx(Kn,{path:"signin",element:r?f.jsx(di,{to:"/diary",replace:!0}):f.jsx(lV,{})}),f.jsx(Kn,{path:"diary",element:r?f.jsx(_q,{}):f.jsx(di,{to:"/"})}),f.jsx(Kn,{path:"products",element:r?f.jsx(pX,{}):f.jsx(di,{to:"/"})}),f.jsx(Kn,{path:"exercises",element:r?f.jsx(OZ,{}):f.jsx(di,{to:"/"})}),f.jsx(Kn,{path:"profile",element:r?f.jsx(eJ,{}):f.jsx(di,{to:"/"})}),f.jsx(Kn,{path:"*",element:f.jsx(l6,{})})]})})}const wJ="/power-pulse/assets/Roboto-Regular-4e147ab6.ttf",bJ="/power-pulse/assets/Roboto-Medium-9d0d55a3.ttf",SJ="/power-pulse/assets/Roboto-Bold-ec685a46.ttf",EJ=a0`
...
`;var $x="persist:",Rx="persist/FLUSH",qf="persist/REHYDRATE",Mx="persist/PAUSE",Ax="persist/PERSIST",Ix="persist/PURGE",Fx="persist/REGISTER",CJ=-1;function Zc(e){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?Zc=function(n){return typeof n}:Zc=function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},Zc(e)}function $E(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),n.push.apply(n,r)}return n}function kJ(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?$E(n,!0).forEach(function(r){OJ(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):$E(n).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function OJ(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function TJ(e,t,n,r){r.debug;var i=kJ({},n);return e&&Zc(e)==="object"&&Object.keys(e).forEach(function(o){o!=="_persist"&&t[o]===n[o]&&(i[o]=e[o])}),i}function PJ(e){var t=e.blacklist||null,n=e.whitelist||null,r=e.transforms||[],i=e.throttle||0,o="".concat(e.keyPrefix!==void 0?e.keyPrefix:$x).concat(e.key),a=e.storage,s;e.serialize===!1?s=function(E){return E}:typeof e.serialize=="function"?s=e.serialize:s=_J;var l=e.writeFailHandler||null,u={},c={},d=[],p=null,m=null,h=function(E){Object.keys(E).forEach(function(C){v(C)&&u[C]!==E[C]&&d.indexOf(C)===-1&&d.push(C)}),Object.keys(u).forEach(function(C){E[C]===void 0&&v(C)&&d.indexOf(C)===-1&&u[C]!==void 0&&d.push(C)}),p===null&&(p=setInterval(g,i)),u=E};function g(){if(d.length===0){p&&clearInterval(p),p=null;return}var w=d.shift(),E=r.reduce(function(C,k){return k.in(C,w,u)},u[w]);if(E!==void 0)try{c[w]=s(E)}catch(C){console.error("redux-persist/createPersistoid: error serializing state",C)}else delete c[w];d.length===0&&x()}function x(){Object.keys(c).forEach(function(w){u[w]===void 0&&delete c[w]}),m=a.setItem(o,s(c)).catch(y)}function v(w){return!(n&&n.indexOf(w)===-1&&w!=="_persist"||t&&t.indexOf(w)!==-1)}function y(w){l&&l(w)}var b=function(){for(;d.length!==0;)g();return m||Promise.resolve()};return{update:h,flush:b}}function _J(e){return JSON.stringify(e)}function DJ(e){var t=e.transforms||[],n="".concat(e.keyPrefix!==void 0?e.keyPrefix:$x).concat(e.key),r=e.storage;e.debug;var i;return e.deserialize===!1?i=function(a){return a}:typeof e.deserialize=="function"?i=e.deserialize:i=jJ,r.getItem(n).then(function(o){if(o)try{var a={},s=i(o);return Object.keys(s).forEach(function(l){a[l]=t.reduceRight(function(u,c){return c.out(u,l,s)},i(s[l]))}),a}catch(l){throw l}else return})}function jJ(e){return JSON.parse(e)}function $J(e){var t=e.storage,n="".concat(e.keyPrefix!==void 0?e.keyPrefix:$x).concat(e.key);return t.removeItem(n,RJ)}function RJ(e){}function RE(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),n.push.apply(n,r)}return n}function Fr(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?RE(n,!0).forEach(function(r){MJ(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):RE(n).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function MJ(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function AJ(e,t){if(e==null)return{};var n=IJ(e,t),r,i;if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);for(i=0;i<o.length;i++)r=o[i],!(t.indexOf(r)>=0)&&Object.prototype.propertyIsEnumerable.call(e,r)&&(n[r]=e[r])}return n}function IJ(e,t){if(e==null)return{};var n={},r=Object.keys(e),i,o;for(o=0;o<r.length;o++)i=r[o],!(t.indexOf(i)>=0)&&(n[i]=e[i]);return n}var FJ=5e3;function NJ(e,t){var n=e.version!==void 0?e.version:CJ;e.debug;var r=e.stateReconciler===void 0?TJ:e.stateReconciler,i=e.getStoredState||DJ,o=e.timeout!==void 0?e.timeout:FJ,a=null,s=!1,l=!0,u=function(d){return d._persist.rehydrated&&a&&!l&&a.update(d),d};return function(c,d){var p=c||{},m=p._persist,h=AJ(p,["_persist"]),g=h;if(d.type===Ax){var x=!1,v=function(_,D){x||(d.rehydrate(e.key,_,D),x=!0)};if(o&&setTimeout(function(){!x&&v(void 0,new Error('redux-persist: persist timed out for persist key "'.concat(e.key,'"')))},o),l=!1,a||(a=PJ(e)),m)return Fr({},t(g,d),{_persist:m});if(typeof d.rehydrate!="function"||typeof d.register!="function")throw new Error("redux-persist: either rehydrate or register is not a function on the PERSIST action. This can happen if the action is being replayed. This is an unexplored use case, please open an issue and we will figure out a resolution.");return d.register(e.key),i(e).then(function(k){var _=e.migrate||function(D,$){return Promise.resolve(D)};_(k,n).then(function(D){v(D)},function(D){v(void 0,D)})},function(k){v(void 0,k)}),Fr({},t(g,d),{_persist:{version:n,rehydrated:!1}})}else{if(d.type===Ix)return s=!0,d.result($J(e)),Fr({},t(g,d),{_persist:m});if(d.type===Rx)return d.result(a&&a.flush()),Fr({},t(g,d),{_persist:m});if(d.type===Mx)l=!0;else if(d.type===qf){if(s)return Fr({},g,{_persist:Fr({},m,{rehydrated:!0})});if(d.key===e.key){var y=t(g,d),b=d.payload,w=r!==!1&&b!==void 0?r(b,c,y,e):y,E=Fr({},w,{_persist:Fr({},m,{rehydrated:!0})});return u(E)}}}if(!m)return t(c,d);var C=t(g,d);return C===g?c:u(Fr({},C,{_persist:m}))}}function ME(e){return BJ(e)||zJ(e)||LJ()}function LJ(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function zJ(e){if(Symbol.iterator in Object(e)||Object.prototype.toString.call(e)==="[object Arguments]")return Array.from(e)}function BJ(e){if(Array.isArray(e)){for(var t=0,n=new Array(e.length);t<e.length;t++)n[t]=e[t];return n}}function AE(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),n.push.apply(n,r)}return n}function Gv(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?AE(n,!0).forEach(function(r){UJ(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):AE(n).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function UJ(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var zD={registry:[],bootstrapped:!1},WJ=function(){var t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:zD,n=arguments.length>1?arguments[1]:void 0;switch(n.type){case Fx:return Gv({},t,{registry:[].concat(ME(t.registry),[n.key])});case qf:var r=t.registry.indexOf(n.key),i=ME(t.registry);return i.splice(r,1),Gv({},t,{registry:i,bootstrapped:i.length===0});default:return t}};function VJ(e,t,n){var r=n||!1,i=b0(WJ,zD,t&&t.enhancer?t.enhancer:void 0),o=function(u){i.dispatch({type:Fx,key:u})},a=function(u,c,d){var p={type:qf,payload:c,err:d,key:u};e.dispatch(p),i.dispatch(p),r&&s.getState().bootstrapped&&(r(),r=!1)},s=Gv({},i,{purge:function(){var u=[];return e.dispatch({type:Ix,result:function(d){u.push(d)}}),Promise.all(u)},flush:function(){var u=[];return e.dispatch({type:Rx,result:function(d){u.push(d)}}),Promise.all(u)},pause:function(){e.dispatch({type:Mx})},persist:function(){e.dispatch({type:Ax,register:o,rehydrate:a})}});return t&&t.manualPersist||s.persist(),s}var Nx={},Lx={};Lx.__esModule=!0;Lx.default=qJ;function Jc(e){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?Jc=function(n){return typeof n}:Jc=function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},Jc(e)}function zm(){}var HJ={getItem:zm,setItem:zm,removeItem:zm};function YJ(e){if((typeof self>"u"?"undefined":Jc(self))!=="object"||!(e in self))return!1;try{var t=self[e],n="redux-persist ".concat(e," test");t.setItem(n,"test"),t.getItem(n),t.removeItem(n)}catch{return!1}return!0}function qJ(e){var t="".concat(e,"Storage");return YJ(t)?self[t]:HJ}Nx.__esModule=!0;Nx.default=GJ;var QJ=KJ(Lx);function KJ(e){return e&&e.__esModule?e:{default:e}}function GJ(e){var t=(0,QJ.default)(e);return{getItem:function(r){return new Promise(function(i,o){i(t.getItem(r))})},setItem:function(r,i){return new Promise(function(o,a){o(t.setItem(r,i))})},removeItem:function(r){return new Promise(function(i,o){i(t.removeItem(r))})}}}var BD=void 0,XJ=ZJ(Nx);function ZJ(e){return e&&e.__esModule?e:{default:e}}var JJ=(0,XJ.default)("local");BD=JJ;const IE={user:{name:null,email:null,height:160,currentWeight:60,desiredWeight:55,birthday:"08.01.1987",blood:1,sex:"male",levelActivity:2},token:null,isLoggedIn:!1,goToParams:!1,isRefreshing:!1},eee=of({name:"auth",initialState:IE,extraReducers:e=>e.addCase(Tc.pending,(t,n)=>t).addCase(Tc.fulfilled,(t,n)=>{t.user=n.payload.user,t.token=n.payload.token,t.isLoggedIn=!1,t.goToParams=!0}).addCase(Tc.rejected,(t,n)=>t).addCase(wT.fulfilled,(t,n)=>{t.user=n.payload.user,t.token=n.payload.token,t.isLoggedIn=!0}).addCase(df.fulfilled,t=>{t.user=IE.user,t.token=null,t.isLoggedIn=!1}).addCase(Pc.pending,(t,n)=>{t.isRefreshing=!0}).addCase(Pc.fulfilled,(t,n)=>{t.user=n.payload,t.isLoggedIn=!0,t.isRefreshing=!1}).addCase(Pc.rejected,(t,n)=>{t.isRefreshing=!1}).addCase(_c.pending,(t,n)=>t).addCase(_c.fulfilled,(t,n)=>{t.user=n.payload,t.isLoggedIn=!0,t.goToParams=!1,t.token=n.payload.token}).addCase(_c.rejected,(t,n)=>{t.isLoggedIn=!0,t.goToParams=!1}).addCase(So.pending,(t,n)=>t).addCase(So.fulfilled,(t,n)=>{t.user=n.payload,t.isLoggedIn=!0,t.token=n.payload.token}).addCase(So.rejected,(t,n)=>t).addCase(Dc.pending,(t,n)=>t).addCase(Dc.fulfilled,(t,n)=>{t.user=n.payload,t.isLoggedIn=!0,t.goToParams=!1,t.token=n.payload.token}).addCase(Dc.rejected,(t,n)=>{t.isLoggedIn=!0,t.goToParams=!1})}),tee=eee.reducer,ic=e=>{e.isLoading=!0},Bm=(e,t)=>{e.isLoading=!1,e.error=t.payload,console.log("state.items",e.items)},nee=of({name:"exercises",initialState:{exercises:[],bodyParts:[],muscules:[],equipment:[],isLoading:!1,error:null},extraReducers:e=>e.addCase(Qv.pending,ic).addCase(Qv.fulfilled,(t,n)=>{t.isLoading=!1,t.error=null,t.exercises=n.payload}).addCase(Qc.pending,ic).addCase(Qc.fulfilled,(t,n)=>{t.isLoading=!1,t.error=null,t.bodyParts=n.payload}).addCase(Qc.rejected,Bm).addCase(Kc.pending,ic).addCase(Kc.fulfilled,(t,n)=>{t.isLoading=!1,t.error=null,t.muscules=n.payload}).addCase(Kc.rejected,Bm).addCase(Gc.pending,ic).addCase(Gc.fulfilled,(t,n)=>{t.isLoading=!1,t.error=null,t.equipment=n.payload}).addCase(Gc.rejected,Bm)}),ree=nee.reducer,iee={isLoading:!1,error:null,productsAndExercisesError:null,burnedCalories:0,consumedCalories:0,doneExercisesTime:0,products:[],exercises:[]},zs=e=>{e.isLoading=!0,e.error=null},oc=e=>{e.isLoading=!1,e.error=null},ac=(e,t)=>{e.isLoading=!0,e.error=t.error},oee=of({name:"diary",initialState:iee,extraReducers:e=>{e.addCase(Nc.pending,zs),e.addCase(Nc.fulfilled,(t,{payload:n})=>{t.isLoading=!1,t.products=n.products||[],t.exercises=n.exercises||[],t.burnedCalories=n.burnedCalories||0,t.consumedCalories=n.consumedCalories||0,t.doneExercisesTime=n.doneExercisesTime||0}),e.addCase(Nc.rejected,(t,{payload:n})=>{t.productsAndExercisesError=n,t.isLoading=!1,t.products=[],t.exercises=[]}),e.addCase(Lc.pending,zs),e.addCase(Lc.fulfilled,(t,n)=>{oc(t),t.products=n.payload}),e.addCase(Lc.rejected,ac),e.addCase(Bc.pending,zs),e.addCase(Bc.fulfilled,(t,n)=>{oc(t),t.exercises=n.payload}),e.addCase(Bc.rejected,ac),e.addCase(zc.pending,zs),e.addCase(zc.fulfilled,(t,{payload:n})=>{oc(t);const r=t.products.filter(i=>i._id!==n);t.products=r}),e.addCase(zc.rejected,ac),e.addCase(Uc.pending,zs),e.addCase(Uc.fulfilled,(t,{payload:n})=>{oc(t);const r=t.exercises.filter(i=>i._id!==n);t.exercises=r}),e.addCase(Uc.rejected,ac)}}),aee=oee.reducer,see=[...ZO({serializableCheck:{ignoredActions:[Rx,qf,Mx,Ax,Ix,Fx]}})],lee={key:"auth",storage:BD,whitelist:["token"]},UD=rA({reducer:{auth:NJ(lee,tee),exercises:ree,diary:aee,products:pG},middleware:see,devTools:!1}),uee=VJ(UD);function ed(e){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?ed=function(n){return typeof n}:ed=function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},ed(e)}function cee(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function FE(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function dee(e,t,n){return t&&FE(e.prototype,t),n&&FE(e,n),e}function pee(e,t){return t&&(ed(t)==="object"||typeof t=="function")?t:td(e)}function Xv(e){return Xv=Object.setPrototypeOf?Object.getPrototypeOf:function(n){return n.__proto__||Object.getPrototypeOf(n)},Xv(e)}function td(e){if(e===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function fee(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&Zv(e,t)}function Zv(e,t){return Zv=Object.setPrototypeOf||function(r,i){return r.__proto__=i,r},Zv(e,t)}function nd(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var WD=function(e){fee(t,e);function t(){var n,r;cee(this,t);for(var i=arguments.length,o=new Array(i),a=0;a<i;a++)o[a]=arguments[a];return r=pee(this,(n=Xv(t)).call.apply(n,[this].concat(o))),nd(td(r),"state",{bootstrapped:!1}),nd(td(r),"_unsubscribe",void 0),nd(td(r),"handlePersistorState",function(){var s=r.props.persistor,l=s.getState(),u=l.bootstrapped;u&&(r.props.onBeforeLift?Promise.resolve(r.props.onBeforeLift()).finally(function(){return r.setState({bootstrapped:!0})}):r.setState({bootstrapped:!0}),r._unsubscribe&&r._unsubscribe())}),r}return dee(t,[{key:"componentDidMount",value:function(){this._unsubscribe=this.props.persistor.subscribe(this.handlePersistorState),this.handlePersistorState()}},{key:"componentWillUnmount",value:function(){this._unsubscribe&&this._unsubscribe()}},{key:"render",value:function(){return typeof this.props.children=="function"?this.props.children(this.state.bootstrapped):this.state.bootstrapped?this.props.children:this.props.loading}}]),t}(S.PureComponent);nd(WD,"defaultProps",{children:null,loading:null});Hm.createRoot(document.getElementById("root")).render(f.jsx(j.StrictMode,{children:f.jsx(kM,{store:UD,children:f.jsx(WD,{loading:null,persistor:uee,children:f.jsxs(dj,{basename:"/power-pulse",children:[f.jsx(EJ,{}),f.jsx(xJ,{}),f.jsx(Pv,{})]})})})}))});export default hee();
