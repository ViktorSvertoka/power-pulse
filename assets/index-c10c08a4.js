...
`;O.button`
  ...
  justify-content: space-around;
  align-items: center;
`;const dx=({selectedDate:e,setSelectedDate:t,isOpen:n})=>{const r=i=>{t(i)};return f.jsxs(DW,{children:[f.jsx(cx,{selected:e,onChange:r,dateFormat:"dd MM yyyy",calendarStartDay:1,formatWeekDay:i=>i.substr(0,1),open:n,customInput:f.jsx("div",{style:{display:"none"}}),popperModifiers:{preventOverflow:{enabled:!0,escapeWithReference:!1,boundariesElement:"viewport"}}}),f.jsx(jW,{})]})};dx.propTypes={selectedDate:pe.instanceOf(Date),setSelectedDate:pe.func,isOpen:pe.bool};const $W=({values:e,handleChange:t,touched:n,errors:r,updateFormData:i,height:o,currentWeight:a,desiredWeight:s,birthday:l})=>{const u=(d,p)=>{t(d,p),i(d,p)},c=d=>n[d]&&!r[d];return S.useEffect(()=>{o!==e.height&&t("height",o),a!==e.currentWeight&&t("currentWeight",a),s!==e.desiredWeight&&t("desiredWeight",s),l!==e.birthday&&t("birthday",l)},[o,a,s,l]),f.jsxs(OW,{children:[f.jsxs(Wu,{children:[f.jsx(Vu,{htmlFor:"height",hidden:!0,children:"Height"}),f.jsx(ym,{type:"number",name:"height",placeholder:"Height",value:e.height,onChange:d=>u("height",d.target.value),className:` ${c("height")?"success":""} ${n.height&&r.height?"error":""}`}),f.jsx(Hu,{name:"height",component:"div",className:"error"})]}),f.jsxs(Wu,{children:[f.jsx(Vu,{htmlFor:"currentWeight",hidden:!0,children:"Current Weight"}),f.jsx(ym,{type:"number",name:"currentWeight",placeholder:"Current",value:e.currentWeight,onChange:d=>u("currentWeight",d.target.value),className:` ${c("currentWeight")?"success":""} ${n.currentWeight&&r.currentWeight?"error":""}`}),f.jsx(Hu,{name:"currentWeight",component:"div",className:"error"})]}),f.jsxs(Wu,{children:[f.jsx(Vu,{htmlFor:"desiredWeight",hidden:!0,children:"Desired Weight"}),f.jsx(ym,{type:"number",name:"desiredWeight",placeholder:"Desired",value:e.desiredWeight,onChange:d=>u("desiredWeight",d.target.value),className:` ${c("desiredWeight")?"success":""} ${n.desiredWeight&&r.desiredWeight?"error":""}`}),f.jsx(Hu,{name:"desiredWeight",component:"div",className:"error"})]}),f.jsxs(Wu,{children:[f.jsx(Vu,{htmlFor:"birthday",hidden:!0,children:"Birthday"}),f.jsxs(_W,{children:[f.jsx(TW,{name:"birthday",selected:e.birthday||null,value:e.birthday,onChange:d=>u("birthday",d),dateFormat:"dd/MM/yyyy",placeholderText:"Birthday",className:` ${c("birthday")?"success":""} ${n.birthday&&r.birthday?"error":""}`}),f.jsx(dx,{}),f.jsx(PW,{children:f.jsx("use",{href:`${be}#icon-calendar-white`})})]}),f.jsx(Hu,{name:"birthday",component:"div",className:"error"})]})]})},Oo=({id:e,name:t,value:n,checked:r,label:i,onChange:o})=>f.jsxs("div",{className:"radio",children:[f.jsx("input",{className:"radio-input",type:"radio",id:e,name:t,value:n,checked:r,onChange:o}),f.jsx("label",{className:"radio-label",htmlFor:e,children:i})]});Oo.propTypes={id:pe.string.isRequired,name:pe.string.isRequired,value:pe.string.isRequired,checked:pe.bool.isRequired,label:pe.string.isRequired,onChange:pe.func.isRequired};const RW=O.div`
  margin-top: 12px;
  display: flex;
  flex-wrap: wrap;
...
`,Em=O.svg`
  ...
  height: 100%;
  fill: #e6533c;
`,u_=({onDateChange:e})=>{const[t,n]=S.useState(new Date),[r,i]=S.useState(!1),o=c=>{const d=new Date(c),p=String(d.getDate()).padStart(2,"0"),m=String(d.getMonth()+1).padStart(2,"0"),h=d.getFullYear();return`${p}/${m}/${h}`},a=()=>{const c=new Date(t);c.setDate(c.getDate()-1);const d=o(c);n(c),e&&e(d)},s=()=>{const c=new Date(t);c.setDate(c.getDate()+1),n(c),e&&e(c)},l=o(t),u=()=>{i(c=>!c)};return f.jsxs(jV,{children:[f.jsxs(AV,{onClick:u,id:"calenderBtn",children:[f.jsx(RV,{children:l}),f.jsx(MV,{children:f.jsx(Em,{children:f.jsx("use",{href:`${be}#icon-calendar-orange`})})})]}),f.jsx(IV,{className:"button",tabIndex:r?-1:0,onClick:a,children:f.jsx(Em,{children:f.jsx("use",{href:`${be}#icon-chevron-left`})})}),f.jsx($V,{className:"button",tabIndex:r?-1:0,onClick:s,children:f.jsx(Em,{children:f.jsx("use",{href:`${be}#icon-chevron-right`})})}),r&&f.jsx(dx,{selectedDate:t,setSelectedDate:n,isOpen:r,setIsOpen:i})]})};u_.propTypes={onDateChange:pe.func};const FV=()=>f.jsxs("svg",{width:"24",height:"24",children:[f.jsx("circle",{cx:"12",cy:"12",r:"12",fill:"#EFA082"}),f.jsx("text",{x:"50%",y:"50%",textAnchor:"middle",dy:".3em",fill:"white",fontSize:"1.2em",children:"!"})]}),NV=O.ul`
  display: grid;
  width: 335px;
  gap: 13px;
  margin-bottom: 48px;
...
`])),Xn*.14,Xn,Xn*.11,Xn*.35,Xn,Xn*.35,Xn*.01,Xn,Xn*.99);yu.path(xS||(xS=Z_([`
  stroke-dasharray: `,"px, ",`;
  stroke-dashoffset: 0;
...
`],[`
  animation: `,` 0.75s steps(12, end) infinite;
  animation-duration: `,`s;
`])),Cq,Eq("speed","0.75"));yu.polyline(DS||(DS=Ex([`
  stroke-width: `,`px;
...
`,YG=e=>{const t=String(e.getDate()).padStart(2,"0"),n=String(e.getMonth()+1).padStart(2,"0"),r=e.getFullYear();return`${t}/${n}/${r}`},DD=({eldata:e,onClick:t,closeModal:n})=>{const r=kt(),{title:i,calories:o,category:a,weight:s,_id:l}=e,[u,c]=S.useState(1),p=lt(li).blood;S.useEffect(()=>{r(So())},[r]);const m=Math.round(u*o/100),h=localStorage.getItem("selectedDate");let g=new Date;if(h){const y=new Date(h);isNaN(y.getTime())||(g=y)}const x=YG(g),v=()=>{if(!m){Le.error("Must be greater than 0");return}r(Lc({date:x,title:i,productId:l,category:a,weight:s,amount:u,recommended:e.groupBloodNotAllowed[p],calories:o})).then(()=>{t(m)}).catch(y=>{Le(y.message)})};return f.jsx(IG,{children:f.jsxs(FG,{children:[f.jsxs(NG,{children:[f.jsx("label",{children:f.jsx(LG,{type:"text",value:i,disabled:!0})}),f.jsxs("label",{style:{position:"relative"},children:[f.jsx(zG,{value:u,type:"number",min:1,onChange:y=>c(y.target.value)}),f.jsx(BG,{children:"weight"})]})]}),f.jsx("br",{}),f.jsx(yE,{children:f.jsxs(yE,{children:["Calories: ",f.jsx(UG,{children:m})]})}),f.jsx("br",{}),f.jsxs(WG,{children:[f.jsx(VG,{type:"button",onClick:v,children:"Add to diary"}),f.jsx(HG,{type:"button",onClick:n,children:"Cancel"})]})]})})};DD.propTypes={eldata:pe.object.isRequired,onClick:pe.func.isRequired,closeModal:pe.func.isRequired};const qG="/power-pulse/assets/avocado-2x-1cf208a8.png",QG=O.div`
    display: flex;
    flex-direction: column;
    align-items: center;
`,KG=O.div`
...
`,FX=O.span`
  color: var(--white-color);
`,rc={cardLabel:"Workout",btnLabel:"Start",list:{burnedCalories:"Burned calories:",bodyPart:"Body part:",target:"Target:"}},bE=e=>e.slice(0,1).toUpperCase()+e.slice(1),NX=({data:e,openModalToggle:t})=>f.jsxs(OX,{children:[f.jsxs(TX,{children:[f.jsx(PX,{children:rc.cardLabel}),f.jsxs(_X,{onClick:()=>{t(e)},type:"button",children:[rc.btnLabel,f.jsx("span",{children:f.jsx(DX,{children:f.jsx("use",{href:`${be}#icon-arrow-right`})})})]})]}),f.jsxs(jX,{children:[f.jsx(MX,{children:f.jsxs(RX,{width:24,height:24,children:[f.jsx("use",{href:`${be}#icon-run-exercises`}),f.jsx("use",{href:`${be}#icon-running-stick-figure`})]})}),f.jsxs($X,{children:[bE(e.name)," "]})]}),f.jsx(AX,{children:Object.keys(rc.list).map(n=>f.jsxs(IX,{children:[rc.list[n],f.jsx(FX,{children:bE(String(e[n]))})]},n))})]}),LX=O.div`
  display: flex;
`,zX=O.img`
  display: none;
  @media screen and (min-width: 1440px) {
