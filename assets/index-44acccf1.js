...
`," ",t?i==null?void 0:i.Footer:i==null?void 0:i.Header,";","")},r),S.Children.map(n,function(l){if(S.isValidElement(l))return S.cloneElement(l)}))},G2=null,_Y=function(){return G2||(G2=S.createContext(null))},DY=["data","theme","layout","sort","pagination","select","tree","onInit","className","children"],jY={Table:`
  ...
  *:after {
  ...
  `.concat(_.isShiftDown?`
    ...
    `:"",`
  `))," ",j==null?void 0:j.Table,";",""),className:oi(p),ref:E},h),w&&ie(z.Provider,{value:n},ie(Xo.Provider,{value:j},ie(L.Provider,{value:o},ie(N.Provider,{value:s},ie(G.Provider,{value:l},ie(K.Provider,{value:a},ie(ZH,{layout:i,tableElementRef:g,tableMemoryRef:x},m&&m(v)))))))))}),A_=function(){return`
  display: contents;
...
`,mZ=O.span`
  ...
  display: inline-flex;
  margin-left: 3px;
`;var gZ=typeof Bs=="object"&&Bs&&Bs.Object===Object&&Bs,vZ=typeof self=="object"&&self&&self.Object===Object&&self;gZ||vZ||Function("return this")();const yZ=({data:e,setDinamicBurnCal:t,dinamicBurnCal:n,setDinamicTime:r})=>{const[i,o]=S.useState(!1),a=()=>{o(!i)},s=({remainingTime:l})=>{const u=e.time*60;t(()=>{const m=(u-l)/u*e.burnedCalories;return Math.round(m)}),r(()=>u-l);const c=Math.floor(l/60),d=l%60;return`${c}:${d}`};return f.jsxs(uZ,{children:[f.jsx(cZ,{children:"Time"}),f.jsx(LD,{strokeWidth:2,size:124,isPlaying:i,duration:e.time*60,colors:"var(--orange-color)",remainingTime:e.time*60,children:({remainingTime:l})=>f.jsx("div",{style:{color:"#fff"},role:"timer","aria-live":"assertive",children:s({remainingTime:l})})}),f.jsxs(dZ,{children:[e.time," minutes"]}),f.jsx(pZ,{onClick:a,children:f.jsx(fZ,{children:f.jsx("use",{href:i?`${be}#icon-pause-square`:`${be}#icon-play`})})}),f.jsxs(hZ,{children:["Burned calories:",f.jsx(mZ,{children:n})]})]})},xZ=e=>{const t=String(e.getDate()).padStart(2,"0"),n=String(e.getMonth()+1).padStart(2,"0"),r=e.getFullYear();return`${t}/${n}/${r}`},wZ=({data:e,onClick:t,closeModal:n})=>{const{bodyPart:r,equipment:i,burnedCalories:o,gifUrl:a,name:s,target:l,_id:u,time:c}=e,[d,p]=S.useState(0),[m,h]=S.useState(0),g=kt();S.useEffect(()=>{g(So())},[g]);const x=Math.round(o/(c*60)*180),v=localStorage.getItem("selectedDate");let y=new Date;if(v){const E=new Date(v);isNaN(E.getTime())||(y=E)}const b=xZ(y),w=()=>{if(!x){Le.error("Must be greater than 0");return}g(Bc({date:b,bodyPart:r,target:l,time:m,exerciseId:u,equipment:i,name:s,burnedCalories:d})),t()};return f.jsx(GX,{children:f.jsxs(XX,{children:[f.jsx(ZX,{children:f.jsx(eZ,{src:a,alt:s})}),f.jsx(JX,{children:f.jsx(yZ,{data:e,setDinamicBurnCal:p,dinamicBurnCal:d,setDinamicTime:h})}),f.jsx(KX,{name:s,bodypart:r,target:l,equipment:i,time:c}),f.jsx(tZ,{children:f.jsx(nZ,{type:"button",onClick:w,children:"Add to diary"})})]})})},bZ="/power-pulse/assets/like-2x-0a7f921f.png",SZ=O.div`
  display: flex;
  flex-direction: column;
  align-items: center;
`,EZ=O.div`
...
`,CJ=()=>f.jsx(gs,{children:f.jsxs(sJ,{children:[f.jsxs(uJ,{children:[f.jsx(jE,{children:f.jsx("use",{href:`${be}#icon-line`})}),f.jsx(DE,{children:"Transforming your body shape with Power Pulse"}),f.jsxs(cJ,{children:[f.jsx(RE,{to:"/signup",children:"Sign Up"}),f.jsx($E,{to:"/signin",children:"Sign In"})]})]}),f.jsxs(lJ,{children:[f.jsx(DE,{children:"Transforming your body shape with Power Pulse"}),f.jsx(jE,{children:f.jsx("use",{href:`${be}#icon-line`})}),f.jsxs(dJ,{children:[f.jsx(RE,{to:"/signup",children:"Sign Up"}),f.jsx($E,{to:"/signin",children:"Sign In"})]})]}),f.jsx(EJ,{children:f.jsxs(pJ,{children:[f.jsxs(fJ,{children:[f.jsx(mJ,{children:f.jsx(hJ,{children:f.jsx("use",{href:`${be}#icon-Polygon-1`})})}),f.jsxs(gJ,{children:["350+ ",f.jsx(vJ,{children:"Video tutorial"})]})]}),f.jsxs(yJ,{children:[f.jsx(wJ,{children:f.jsx(xJ,{children:f.jsx("use",{href:`${be}#icon-running-stick-figure`})})}),f.jsxs(bJ,{children:["500 ",f.jsx(SJ,{children:"cal"})]})]})]})})]})});function kJ(){const e=kt(),{goToParams:t,isLoggedIn:n}=_T();return S.useEffect(()=>{e(Pc())},[e]),f.jsx(a3,{children:f.jsxs(Kn,{path:"/",element:f.jsx(r6,{}),children:[f.jsx(Kn,{index:!0,element:n?f.jsx(di,{to:"/diary",replace:!0}):f.jsx(CJ,{})}),f.jsx(Kn,{path:"signup",element:t?f.jsx(di,{to:"/params",replace:!0}):f.jsx(x7,{})}),f.jsx(Kn,{path:"params",element:t?f.jsx(WW,{}):f.jsx(di,{to:"/diary",replace:!0})}),f.jsx(Kn,{path:"signin",element:n?f.jsx(di,{to:"/diary",replace:!0}):f.jsx(pV,{})}),f.jsx(Kn,{path:"diary",element:n?f.jsx($q,{}):f.jsx(di,{to:"/"})}),f.jsx(Kn,{path:"products",element:n?f.jsx(mX,{}):f.jsx(di,{to:"/"})}),f.jsx(Kn,{path:"exercises",element:n?f.jsx(jZ,{}):f.jsx(di,{to:"/"})}),f.jsx(Kn,{path:"profile",element:n?f.jsx(aJ,{}):f.jsx(di,{to:"/"})}),f.jsx(Kn,{path:"*",element:f.jsx(p6,{})})]})})}const OJ="/power-pulse/assets/Roboto-Regular-4e147ab6.ttf",TJ="/power-pulse/assets/Roboto-Medium-9d0d55a3.ttf",PJ="/power-pulse/assets/Roboto-Bold-ec685a46.ttf",_J=l0`
